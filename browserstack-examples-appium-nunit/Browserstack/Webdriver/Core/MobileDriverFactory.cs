...
namespace BrowserStack.WebDriver.Core
{
    ...
    public class MobileDriverFactory
    {
        ...
        private readonly string BROWSERSTACK_APP_ID = "abcd";
        ...
        public readonly string BROWSERSTACK_BUILD_NAME= "abcd";
        ...
        public AppiumDriver<AppiumWebElement> CreateRemoteMobileDriver(AppiumOptions platformCapabilities)
        {
            ...
            {
                if (Environment.GetEnvironmentVariable(BROWSERSTACK_APP_ID) != null)
                {
                    platformCapabilities.AddAdditionalCapability("app", Environment.GetEnvironmentVariable(BROWSERSTACK_APP_ID));
                }
